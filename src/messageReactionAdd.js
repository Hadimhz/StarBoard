...
let register = () => {
    index_1.client.on('messageReactionAdd', async (reaction, user) => {
        var _a, _b, _c, _d;
        ...
        // if reaction count is more than minReactions(config) and requires staff reactions, fetch all users.
